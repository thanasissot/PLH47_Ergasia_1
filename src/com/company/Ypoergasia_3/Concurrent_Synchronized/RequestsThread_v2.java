...
public class RequestsThread_v2 extends Thread{
    private final ConcurrentHashMap<Character, Integer> characterMap;
    ...
    public RequestsThread_v2(ConcurrentHashMap<Character, Integer> characterMap, List<Integer> lengths, int apiCallsCount, String url) throws MalformedURLException {
        ...
        for (int i = 0; i < apiCallsCount; i++){
            ...
            while (matcher.find()){
                ...
                for (char character : word.toCharArray()){
                    characterMap.merge(character, 1, Integer::sum);
                }
            }
        }
    }
